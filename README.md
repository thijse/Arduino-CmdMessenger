...
Arduino Build status:[![Arduino Build Status](https://travis-ci.org/thijse/Arduino-CmdMessenger.svg?branch=master)](https://travis-ci.org/thijse/Arduino-CmdMessenger)
