...
namespace CommandMessenger.IntegrationTests
{
    ...
    public abstract class LoopbackScenariosBase : IDisposable
    {
        ...
        /// <summary>
        /// Waits for the firmware to be ready. Default: wait for kAcknowledge (boot ack).
        /// Override for boards that don't reset on serial open (e.g. Teensy).
        /// </summary>
        protected virtual void WaitForReady()
        {
